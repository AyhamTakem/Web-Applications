...
<h2 class="text-center text-danger">Insert Your Categories</h2>
...
<div class="input-group w-90 mb-2">
    ...
    name="cat_title"
    placeholder="Insert Categories" aria-label="Categories" aria-describedby="basic-addon1" required="required">
</div>
<div class="input-group w-10 mb-2 m-auto">
  ...
  <!-- <button class="bg-danger text-light p-2 my-3 border-0 rounded">Insert Categories</button> -->
</div>
</form>