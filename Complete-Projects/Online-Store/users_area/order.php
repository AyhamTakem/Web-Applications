...
<?php
  ...
  $total_price=0;
  $cart_query_pric="Select * from `cart_details` where ip_address='$get_ip_address'";
  $result_cart_price=mysqli_query($con,$cart_query_pric);
...
//   while($row_product_price=mysqli_fetch_array($run_cart)){
//     $product_price=array($row_product_price['product_price']);
//     $product_quantity=array_sum($product_price);
//     $total_price+=$product_values;
// }
  if($quantity==1){
